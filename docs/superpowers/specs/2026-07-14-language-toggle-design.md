...
5. **Full content is translated** — nav labels, section headings/descriptions, hero tagline, bio summary, every experience entry's role + description, every project's description, certifications, awards, and CTA/footer text. Project names, company names, technology/skill names (e.g. "Kotlin", "Firebase"), and location names stay as-is in both languages (proper nouns aren't translated).
